...
bool Search::Worker::iterative_deepening() {
           ...
           && !(limits.depth && mainThread && rootDepth >= limits.depth))
    {
        ...
        for (pvIdx = 0; pvIdx < multiPV; ++pvIdx)
        {
            ...
            constexpr int64_t c_base      = 185467;
            constexpr int64_t c_depth     = 3670;
            constexpr int64_t c_std       = 24904;
            constexpr int64_t c_avg       = 9830;
            constexpr int64_t c_d_std     = 262;
            constexpr int64_t c_d_avg     = 524;
            constexpr int64_t c_cap_base  = 1139016;
            constexpr int64_t c_cap_depth = 36176;
